...
from logparser.utils.const import input_dir, general_regex, input_file_suffix, corrected_input_dir, corrected_file_suffix
import os
import pandas as pd
...
def benchmark_time():
    ...
    df_result.set_index("Dataset", inplace=True)
    print(df_result)
    df_result.to_csv("IPLoM_time_result.csv", float_format="%.6f")
...
def benchmark_memory():
    ...
    df_result.set_index("Dataset", inplace=True)
    print(df_result)
    df_result.to_csv("IPLoM_memo_result.csv", float_format="%.6f")
