...
import sys
sys.path.append("../../")
from logparser.OSPattern import LogParser
...
output_dir = "OSPattern_result/"  # The output directory of parsing results
...
def benchmark_accuracy():
    ...
    print(df_result)
    df_result.to_csv("OSPattern_bechmark_result.csv", float_format="%.6f")
...
def benchmark_time():
    ...
    df_result.set_index("Dataset", inplace=True)
    print(df_result)
    df_result.to_csv("OSPattern_time_result.csv", float_format="%.6f")
